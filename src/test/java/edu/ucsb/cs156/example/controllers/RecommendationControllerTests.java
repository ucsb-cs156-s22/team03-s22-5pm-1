...
public class RecommendationControllerTests extends ControllerTestCase {
        ...
        // Authorization tests for /api/recommendations/post
        ...
        public void an_admin_user_can_post_a_new_recommendation() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/recommendations/post?requesterEmail=cgaucho@ucsb.edu&professorEmail=phtcon@ucsb.edu&explanation=BS/MS program&dateRequested=2022-04-20T00:00:00&dateNeeded=2022-05-01T00:00:00&done=false")
                                                // dateNeeded=2022-04-20&dateRequested=2022-05-01&done=false&explanation=BS%2FMS%20Program&professorEmail=phtcon%40ucsb.edu&requesterEmail=cgaucho%40ucsb.edu
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        @WithMockUser(roles = { "ADMIN", "USER" })
        @Test
        public void an_admin_user_can_post_a_new_recommendation2() throws Exception {
                // arrange
                ...
                // act
                MvcResult response = mockMvc.perform(
                                post("/api/recommendations/post?requesterEmail=cgaucho@ucsb.edu&professorEmail=phtcon@ucsb.edu&explanation=BS/MS program&dateRequested=2022-04-20T00:00:00&dateNeeded=2022-05-01T00:00:00&done=true")
                                                // dateNeeded=2022-04-20&dateRequested=2022-05-01&done=false&explanation=BS%2FMS%20Program&professorEmail=phtcon%40ucsb.edu&requesterEmail=cgaucho%40ucsb.edu
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_recommendation() throws Exception {
                ...
                verify(recommendationRepository, times(1)).save(recommendationEdited); // should be saved with correct
                                                                                       // user
                String responseString = response.getResponse().getContentAsString();
