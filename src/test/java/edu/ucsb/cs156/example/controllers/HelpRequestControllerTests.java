...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/HelpRequest/post?requesterEmail=jonahpark@ucsb.edu&tableOrBreakoutRoom=t&explanation=stuck&teamId=1&requestTime=2022-01-03T00:00:00&solved=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        @WithMockUser(roles = { "ADMIN", "USER" })
        @Test
        public void an_admin_user_can_post_a_new_helprequest_true() throws Exception {
                // arrange
                ...
                // act
                MvcResult response = mockMvc.perform(
                                post("/api/HelpRequest/post?requesterEmail=jonahpark@ucsb.edu&tableOrBreakoutRoom=t&explanation=stuck&teamId=1&requestTime=2022-01-03T00:00:00&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_helprequest() throws Exception {
                ...
                HelpRequest helpRequestEdited = HelpRequest.builder()
                                .requesterEmail("jonahpark@gmail.com")
                                .teamId("2")
                                .tableOrBreakoutRoom("br")
                                .explanation("help")
                                .solved(true)
