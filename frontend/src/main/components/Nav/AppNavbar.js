...
export default function AppNavbar({ currentUser, systemInfo, doLogout, currentUrl = window.location.href }) {
  return (
    <>
      ...
      <Navbar expand="m" variant="dark" bg="dark" sticky="top" data-testid="AppNavbar">
        <Container>
            ...
            <Nav className="me-auto">
              ...
              }
              {
                hasRole(currentUser, "ROLE_USER") && (
                  ...
                  <NavDropdown title="Menu Item" id="appnavbar-menu-items-dropdown" data-testid="appnavbar-menu-items-dropdown" >
                    <NavDropdown.Item as={Link} to="/menuitem/list" data-testid="appnavbar-menu-items-list">List Menu Item</NavDropdown.Item>
                  </NavDropdown>
                )
              }
              {
              ...
              }
              {
                hasRole(currentUser, "ROLE_USER") && (
                  <NavDropdown title="Help Requests" id="appnavbar-help-requests-dropdown" data-testid="appnavbar-help-requests-dropdown" >
                    ...
                    <NavDropdown.Item as={Link} to="/helpRequest/list" data-testid="appnavbar-help-requests-list">List Help Requests</NavDropdown.Item>
                  </NavDropdown>
                )
              }
              {
