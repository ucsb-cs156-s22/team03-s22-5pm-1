...
describe("ReviewsTable tests", () => {
  ...
  test("Has the expected column headers and content for adminUser", () => {
    ...
    const expectedHeaders = ['ID', 'Item ID', 'Reviewer Email', 'Local Date/Time', 'Stars', 'Comments'];
    ...
    expect(getByTestId(`${testId}-cell-row-0-col-stars`)).toHaveTextContent(3);
    expect(getByTestId(`${testId}-cell-row-1-col-stars`)).toHaveTextContent(1);
